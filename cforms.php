...
function cforms($args = '',$no = '') {
	...
	if( is_array($_SESSION['cforms']) && $_SESSION['cforms']['current']>0 )
	...
	if( $cformsSettings['form'.$no]['mp']['cforms'.$no.'_mp_form'] && $cformsSettings['form'.$no]['mp']['cforms'.$no.'_mp_first'] ){
    	if ( is_array($_SESSION['cforms']) ){
...
##debug
//	if ( isset($_SESSION['cforms']['count']) && $_SESSION['cforms']['count'] > 0 )
