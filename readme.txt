...
* **NEW:** added **{Author}** variable
* **NEW:** **GeoMapLookup** support for tracked submissions
* **NEW:** Improved **calendar navigation** (Year!)
* **NEW:** Include **cforms HTML HEADER** only one specified pages (optional)
