...
5.2 received a patch (see forum) that fixes the redirection issue to the current page when using cforms **in the sidebar** && **in non-ajax mode**.
...
* Currently, cforms includes the following language packs (besides English):
	...
	* **Hungarian** \* Author: [Ungv&aacute;ri B&eacute;la](http://www.deliciousdays.com/download/cformsII-v51-hu_hu.zip)
