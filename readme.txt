...
cforms is a highly customizable, flexible and powerful contact form plugin.
Covering a variety of features from attachments to multi form management, you
can even have multiple forms on the same page!
...
The CSS information for the 2nd form has been customized for demo purposes, feel free to edit cforms.css and remove the top block (indicated).

[Check here for more up-to-date FAQ's](http://www.deliciousdays.com/cforms-plugin#cffaq)

== Screenshots ==

1. Just a few random user examples
2. Just a few random user examples
3. RTL is also supported!
...
![custom form](form_tshirt_order.jpg)
