<?php
		...
		$cformsSettings['cforms_rsskey'] = md5(rand());
		$cformsSettings['cforms_rss'] = false;
		$cformsSettings['cforms_rsskeyall'] = md5(rand());
		$cformsSettings['cforms_rssall'] = false;
		$cformsSettings['cforms_rss_count'] = 5;
		$cformsSettings['cforms_rssall_count'] = 5;
		...
		add_option('cforms_commentParent', 'mycommentlist');
