<?php
		...
		add_option('cforms_commentInMod', '<em>'.__('Your comment is awaiting moderation.'.'</em>', 'cforms'));
		...
		add_option('cforms_limittxt', '<strong>'.__('No more submissions accepted at this time.'.'</strong>', 'cforms'));
