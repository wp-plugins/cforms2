...
if( isset($_REQUEST['deleteall']) ) {  // erase all cforms data
	...
	$cformsSettings['cforms_rsskeyall'] = md5(rand());
...
###	update new settings container
	$cformsSettings['cforms_show_quicktag_js'] = $_REQUEST['cforms_show_quicktag_js']?true:false;
	$cformsSettings['cforms_rssall'] = $_REQUEST['cforms_rss']?true:false;
	$cformsSettings['cforms_rssall_count'] = $_REQUEST['cforms_rsscount'];
	update_option('cforms_settings',$cformsSettings);
...
//	update_option('cforms_linklove', $_REQUEST['cforms_linklove']?'1':'0');
	...
	update_option('cforms_avatar',			$_REQUEST['cforms_avatar']);
	...
	$captcha['fo']= $_REQUEST['cforms_cap_fo'];
	$captcha['foqa']= $_REQUEST['cforms_cap_foqa'];
		...
		<fieldset id="wpcomment" class="cformsoptions">
			...
			<div id="o28">
				...
				<div class="optionsbox" style="margin-top:15px;">
					...
					<div class="optionsboxR"><input type="text" id="cforms_commentParent" name="cforms_commentParent" value="<?php echo stripslashes(htmlspecialchars( get_option('cforms_commentParent') )); ?>"/><br /><a class="infobutton" href="#" name="it8"><?php _e('Note &raquo;', 'cforms'); ?></a></div>
				...
				<div class="optionsbox" style="margin-top:15px;">
					...
					<div class="optionsboxR" style="margin-bottom:10px;">
						<div id="r17" class="rbox"><textarea rows="80px" cols="200px" name="cforms_commentHTML" id="cforms_commentHTML"><?php echo stripslashes(htmlspecialchars(get_option('cforms_commentHTML'))); ?></textarea><div id="rh17"></div></div><a class="infobutton" href="#" name="it9"><?php _e('Supported Variables &raquo;', 'cforms'); ?></a>&nbsp;&nbsp;&nbsp;<a class="infobutton" href="#" name="it9b"><?php _e('Default Template &raquo;', 'cforms'); ?></a>
						<br />
					</div>
...
&lt;/li&gt;<br />
				...
				<div class="optionsbox">
					...
					<div class="optionsboxR"><input type="text" id="cforms_avatar" name="cforms_avatar" value="<?php echo stripslashes(htmlspecialchars( get_option('cforms_avatar') )); ?>"/></div>
				</div>
		...
		<fieldset id="wpeditor" class="cformsoptions">
			...
			<div id="o12">
				...
				<div class="optionsbox">
					...
					<div class="optionsboxR"><input type="checkbox" id="cforms_show_quicktag_js" name="cforms_show_quicktag_js" <?php if( $cformsSettings['cforms_show_quicktag_js']==true) echo "checked=\"checked\""; ?>/> <?php _e('Select in case you experience a TinyMCE editor error caused by other plugins.', 'cforms') ?></div>
				</div>
			</div>
		</fieldset>
		...
		<fieldset id="captcha" class="cformsoptions">
			...
			<div id="o26">						   
				...
				<div class="optionsbox">
					...
					<div class="optionsboxR"><input type="checkbox" id="cforms_cap_fo" name="cforms_cap_fo" value="1" <?php if($captcha['fo']) echo "checked=\"checked\""; ?>/><label for="cforms_cap_fo"><?php _e('Force CAPTCHA display for logged in users', 'cforms') ?></label></div>
				</div>
		...
		<fieldset id="visitorv" class="cformsoptions">
			...
			<div id="o13">
				...
				<div class="optionsbox">
					...
					<div class="optionsboxR"><input type="checkbox" id="cforms_cap_foqa" name="cforms_cap_foqa" value="1" <?php if($captcha['foqa']) echo "checked=\"checked\""; ?>/><label for="cforms_cap_foqa"><?php _e('Force Q&A display for logged in users', 'cforms') ?></label></div>
				</div>
		...
		<fieldset id="tracking" class="cformsoptions">
			...
			<div id="o14">
				...
				<div class="optionsbox" style="margin-top:10px;">
					...
					<div class="optionsboxR"><input type="checkbox" id="cforms_database" name="cforms_database" <?php if(get_option('cforms_database')=="1") echo "checked=\"checked\""; ?>/> <?php _e('Will create two new tables in your WP database.', 'cforms') ?></div>
				</div>

				<div class="optionsbox">
					<div class="optionsboxL"><label for="cforms_showdashboard"><strong><?php _e('Show on dashboard', 'cforms') ?></strong></label></div>
					<div class="optionsboxR"><input type="checkbox" id="cforms_showdashboard" name="cforms_showdashboard" <?php if(get_option('cforms_showdashboard')=="1") echo "checked=\"checked\""; ?>/> <?php _e('Make sure to enable your forms individually as well!', 'cforms') ?></div>
				</div>

				<div class="optionsbox">
					<div class="optionsboxL"><label for="cforms_rss"><strong><?php _e('Enable global RSS', 'cforms'); ?></strong></label></div>
					<div class="optionsboxR"><input type="checkbox" id="cforms_rss" name="cforms_rss" <?php if( $cformsSettings['cforms_rssall'] ) echo "checked=\"checked\""; ?>/> <?php _e('Enables an RSS feed to track all new submissions across all forms.', 'cforms'); ?></div>
				</div>

				<?php if( current_user_can('track_cforms') && $cformsSettings['cforms_rssall'] ) : ?>
				<div class="optionsbox">
					<div class="optionsboxL"><label for="cforms_rsscount"><strong><?php _e('RSS entries', 'cforms'); ?></strong></label></div>
					<div class="optionsboxR"><input name="cforms_rsscount" id="cforms_rsscount" value="<?php echo $cformsSettings['cforms_rssall_count'];  ?>" /></div>
				</div>
				<div class="optionsbox">
					...
					<div class="optionsboxR">
						<input name="cforms_rsskeyall" id="cforms_rsskey" value="<?php echo $cformsSettings['cforms_rsskeyall'];  ?>" />
						...
						<br /><?php _e('The complete RSS URL &raquo;', 'cforms'); echo '<br />'.get_option('siteurl').'?cformsRSS='.urlencode('-1$#$').$cformsSettings['cforms_rsskeyall']; ?> 
					</div>
				</div>
				<?php endif; ?>
