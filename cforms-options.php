...
<div class="wrap" id="top">
	...
	<fieldset id="anchorfields">
		...
		<table class="mainoptions" title="<?php _e('Navigate to your other forms.', 'cforms') ?>">
		<tr>
			<td class="chgL">
				...
				<input id="cforms_ajax" type="checkbox" class="allchk cforms_ajax" name="cforms_ajax" <?php if($cformsSettings['form'.$no]['cforms'.$no.'_ajax']=="1") echo "checked=\"checked\""; ?>/>
