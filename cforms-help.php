...
[...]<br />
		...
		<div id="o21">
			...
			<table class="hf" cellspacing="2" border="4" width="95%">
				...
				<tr>
					<td class="ball" colspan="2">
						<code>get_cforms_entries('','','','','')   /* all data, no filters */</code>
					</td>
				</tr>
				<tr>
					<td class="ball" colspan="2">
						<code>get_cforms_entries('contact','','','sub_date',5)   /* last 5 submissions of "my contact form", order by date */</code>
					</td>
				</tr>
				<tr>
					<td class="ball" colspan="2">
						<code>get_cforms_entries('',date ("Y-m-d H:i:s", time()-(3600*2)),'','','')   /* all submissions in the last 2 hours */</code>
					</td>
				</tr>
			</table>
