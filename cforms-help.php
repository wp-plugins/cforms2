...
<div class="wrap" id="top">
		...
		<p><?php echo sprintf(__('This manual/help page is also available as a %sPDF document%s.', 'cforms'),'<a href="http://www.deliciousdays.com/download/cforms-manual.pdf">','</a> <img src="'.$cforms_root.'/images/adobe.gif"/>'); ?></p>
			...
			<ol style="margin:10px 0 0 100px;">
				<li><?php echo sprintf(__('First take a look at the <a href="%s">default form</a>', 'cforms'),'?page=' . $plugindir . '/cforms-options.php#anchorfields'); ?>
					<ul style="margin:10px 0 0 30px;">
						...
						<li><?php _e('Check the field labels (field names), if needed make your adjustments', 'cforms'); ?> <button style="vertical-align:middle;" disabled="disabled" class="wrench"/></li>
