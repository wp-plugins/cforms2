<?php
	...
	$cformsSettings['form'.$FORMCOUNT]['cforms'.$FORMCOUNT.'_startdate'] = $cformsSettings['form'.$no]['cforms'.$no.'_startdate'];
	$cformsSettings['form'.$FORMCOUNT]['cforms'.$FORMCOUNT.'_enddate'] = $cformsSettings['form'.$no]['cforms'.$no.'_enddate'];
