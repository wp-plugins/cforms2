<?php
	...
	$cformsSettings['cforms'.$FORMCOUNT.'_rsskey'] = $cformsSettings['cforms'.$no.'_rsskey'];
	$cformsSettings['cforms'.$FORMCOUNT.'_rss'] = $cformsSettings['cforms'.$no.'_rss'];
	$cformsSettings['cforms'.$FORMCOUNT.'_rss_count'] = $cformsSettings['cforms'.$no.'_rss_count'];
