						...
						<div id="f<?php echo $i; ?>" class="groupItem<?php echo $alternate; ?>">
							...
							<div class="itemContent">
								...
								<input class="inpfld" <?php echo $specialclass; ?> name="field_<?php echo($i); ?>_name" id="field_<?php echo($i); ?>_name" size="30" value="<?php echo ($field_type == 'fieldsetend')?'--':$field_name; ?>" /><a href="#" class="jqModal" title="<?php echo $cforms_root.'/js/include/'; ?>"><img class="wrench" src="<?php echo $cforms_root; ?>/images/wrench<?php echo ($alternate<>'')?'-alt':''; ?>.gif" alt="<?php _e('edit', 'cforms'); ?>" title="<?php _e('edit', 'cforms'); ?>"/></a><select class="fieldtype selfld" <?php echo $specialclass; ?> name="field_<?php echo($i); ?>_type" id="field_<?php echo($i); ?>_type">
									...
									<?php if( in_array($field_type,array('hidden','multiselectbox','checkboxgroup', 'radiobuttons','fieldsetstart','fieldsetend','ccbox','captcha','verification','textonly')) ) : ?>
									...
									<?php if( ! in_array($field_type,array('pwfield','textarea','textfield','datepicker','yourname','youremail','friendsname','friendsemail','email','author','url','comment')) ) : ?>
										<img class="chkno" src="<?php echo $cforms_root; ?>/images/chkbox_grey.gif" alt="<?php _e('n/a', 'cforms'); ?>" title="<?php _e('Not available.', 'cforms'); ?>"/>
									<?php else : ?>
									...
									<?php if( ! in_array($field_type,array('pwfield','textarea','textfield','datepicker','checkbox','checkboxgroup','selectbox','multiselectbox','radiobuttons','upload')) ) : ?>
										<img class="chkno" src="<?php echo $cforms_root; ?>/images/chkbox_grey.gif" alt="<?php _e('n/a', 'cforms'); ?>" title="<?php _e('Not available.', 'cforms'); ?>"/>
									<?php else : ?>
									...
									<?php if( ! in_array($field_type,array('pwfield','textarea','textfield','datepicker','checkbox','checkboxgroup','selectbox','multiselectbox','radiobuttons','upload')) ) : ?>
										<img class="chkno" src="<?php echo $cforms_root; ?>/images/chkbox_grey.gif" alt="<?php _e('n/a', 'cforms'); ?>" title="<?php _e('Not available.', 'cforms'); ?>"/>
									<?php else : ?>
										<input class="fieldreadonly chkfld" type="checkbox" name="field_<?php echo($i); ?>_readonly" value="required"  <?php echo($field_readonly == '1'?' checked="checked"':''); ?> />
									<?php endif; ?>
...
<div class="jqmWindow" id="cf_editbox">
	<div class="cf_ed_header jqDrag">Input Field Settings</div>
	<div class="cf_ed_main">
		<div id="cf_target"></div>
		<div class="controls"><a href="#" id="ok" class="jqmClose"><?php _e('OK', 'cforms') ?></a><a href="#" id="cancel" class="jqmClose"><?php _e('Cancel', 'cforms') ?></a></div>
	</div>
</div>
