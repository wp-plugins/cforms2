...
function cforms($args = '',$no = '') {
	...
	if ( get_option('cforms_datepicker')=='1' && !$dpflag ){
		$content .= $indent . $tab . '<div id="datepicker" style="position:absolute;visibility:hidden;background-color:white;layer-background-color:white;z-index:999;"></div><script type="text/javascript">if ( !dp ) dpinit();</script>' . $nl;
		$dpflag   = true;		
	}
