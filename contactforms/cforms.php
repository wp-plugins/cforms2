...
function widget_cforms_init() {
	...
	for ( $i=0;$i<get_option('cforms_formcount');$i++ ) {
		...
		register_sidebar_widget('<span style="line-height:1.2em;padding:5px;display:block;height:31px;width:94%;position:relative; top:-1px; left:0;background:'.$url.'">cformsII ('.$nodisp.')<br />&raquo;'.$form.'</span>', 'widget_cforms','widgetcform'.$i);
	}
