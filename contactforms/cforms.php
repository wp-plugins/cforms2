...
function cforms_style() {
	...
	echo "\t".'<link rel="stylesheet" type="text/css" href="' . $cforms_root . '/styling/cforms.css" />'."\n";
...
function cforms_options_page_style() {
	...
	if (   strpos($_SERVER['REQUEST_URI'], $plugindir.'/cforms') !== false )
		echo	'<link rel="stylesheet" type="text/css" href="' . $cforms_root . '/styling/cforms-admin.css" />' . "\n" .
