...
<img src="<?php echo $cforms_root; ?>/images/cfii.gif" alt="" align="right"/><img src="<?php echo $cforms_root; ?>/images/p4-title.jpg" alt=""/>
	    ...
	    <h3 id="fields"><a class="helptop" href="#top"><?php _e('top', 'cforms'); ?></a><a id="b19" class="blindminus" onfocus="this.blur()" onclick="toggleui(19);return false;" href="#" title="<?php _e('Expand/Collapse', 'cforms') ?>"></a><span class="h3title-no">3.</span><?php _e('Supported form input fields', 'cforms'); ?></h3>
		...
		<div id="o19">
			...
			<ul style="margin:10px 0 0 100px; list-style:square;">
				...
				<li><a href="#single" onclick="setshow(19)"><?php 	_e('Single-, Multi-line fields', 'cforms'); ?></a></li>
			...
			<tr>
				<td class="ball" colspan="2">
					...
					<ol>
						...
						<li><?php echo sprintf(__('There a <a href="%s" %s>three additional</a>, <em>predefined variables</em> that can be used in the <a href="%s" %s>message template</a>.', 'cforms'),'#tafvariables','onclick="setshow(19)"','?page='.$plugindir.'/cforms-options.php#cforms_cmsg','onclick="setshow(5)"'); ?></li>
...
http://www.deliciousdays.com/cforms-forum?forum=2&topic=78&page=1
