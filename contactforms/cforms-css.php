						...
						<table>
							...
							<tr height="200">
								<td colspan="3">
									...
									<input type="submit" name="label-ids" id="label-ids" class="allbuttons addfield" value="<?php if ( get_option('cforms_labelID')=='' || get_option('cforms_labelID')=='0' ) _e('Activate Label IDs', 'cforms'); else  _e('Deactivate Label IDs', 'cforms'); ?>" />
									...
									<br/ >
									<input type="submit" name="li-ids" id="li-ids" class="allbuttons addfield" value="<?php if ( get_option('cforms_liID')=='' || get_option('cforms_liID')=='0' ) _e('Activate List Element IDs', 'cforms'); else  _e('Deactivate List Element IDs', 'cforms'); ?>" />
