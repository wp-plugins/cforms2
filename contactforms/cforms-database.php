	...
	<img src="<?php echo $cforms_root; ?>/images/cfii.gif" alt="" align="right"/><img src="<?php echo $cforms_root; ?>/images/p3-title.jpg" alt=""/>
		...
		<form id="cformsdata" name="form" method="post" action="">
				...
				<ul class="sortheader">
					...
					<li class="col2"><span class="abbr" title="<?php _e('click to sort', 'cforms'); ?>"><a href="javascript:void(0);" onclick="sort_entries('form_id');"><?php _e('Form','cforms') ?></a></span><br/><?php echo $formselect; ?></li>
					<li class="col3"><span class="abbr" title="<?php _e('click to sort', 'cforms'); ?>"><a href="javascript:void(0);" onclick="sort_entries('email');"><?php _e('Who','cforms') ?></a></span><br/><input type="text" name="filter_email" id="filter_email" value="<?php echo $_POST['filter_email']; ?>"/></li>
					<li class="col4"><span class="abbr" title="<?php _e('click to sort', 'cforms'); ?>"><a href="javascript:void(0);" onclick="sort_entries('sub_date');"><?php _e('When','cforms') ?></a></span><br/><input type="text" name="filter_date1" id="filter_date1" value="<?php echo (($_POST['filter_date1']=='')?__('from','cforms'):$_POST['filter_date1']); ?>"/><br/><input type="text" name="filter_date2" id="filter_date2" value="<?php echo (($_POST['filter_date2']=='')?__('to','cforms'):$_POST['filter_date2']); ?>"/></li>
					<li class="col5"><span class="abbr" title="<?php _e('click to sort', 'cforms'); ?>"><a href="javascript:void(0);" onclick="sort_entries('ip');"><?php _e('IP','cforms') ?></a></span><br/><input type="text" name="filter_ip" id="filter_ip" value="<?php echo $_POST['filter_ip']; ?>"/></li>
				</ul>
