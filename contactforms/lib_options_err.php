...
if ( $uriprefix<>'' && (($userconfirm&8)==0) ) {
		$text = sprintf(__('It seems that your ROOT directory for Wordpress is %s. If you encounter issues with Ajax (form submission & CAPTCHA reset) please check the file %s in your cforms plugin folder and set the %s variable accordingly.', 'cforms'),"<strong>$uriprefix</strong>",'<strong>js/cforms.js</strong>','<strong>sajax_uri</strong>');
		showmesssage(8);
} 
